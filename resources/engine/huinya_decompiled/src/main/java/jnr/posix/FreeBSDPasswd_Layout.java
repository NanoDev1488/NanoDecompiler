// исходный (обфусцированный) внутренний класс: jnr.posix.FreeBSDPasswd.Layout
package jnr.posix;
...
import jnr.posix.FreeBSDPasswd_Anon1;

final class FreeBSDPasswd_Layout extends StructLayout {
  ...
  private FreeBSDPasswd_Layout(Runtime arg0) { // было: <init>
        super(arg0);
   ...
   FreeBSDPasswd_Layout(Runtime arg0, FreeBSDPasswd_Anon1 arg1) { // было: <init>
        this(arg0);
    }
