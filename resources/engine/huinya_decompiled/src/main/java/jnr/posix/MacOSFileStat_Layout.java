// исходный (обфусцированный) внутренний класс: jnr.posix.MacOSFileStat.Layout
package jnr.posix;
...
public class MacOSFileStat_Layout extends StructLayout {
  ...
  public final MacOSFileStat_Layout_time_t st_atime;
  public final StructLayout_SignedLong st_atimensec;
  public final MacOSFileStat_Layout_time_t st_mtime;
  public final StructLayout_SignedLong st_mtimensec;
  public final MacOSFileStat_Layout_time_t st_ctime;
  ...
  public MacOSFileStat_Layout(Runtime arg0) { // было: <init>
        super(arg0);
        ...
        st_atime = new MacOSFileStat_Layout_time_t(this);
        st_atimensec = new StructLayout_SignedLong(this);
        st_mtime = new MacOSFileStat_Layout_time_t(this);
        st_mtimensec = new StructLayout_SignedLong(this);
        st_ctime = new MacOSFileStat_Layout_time_t(this);
