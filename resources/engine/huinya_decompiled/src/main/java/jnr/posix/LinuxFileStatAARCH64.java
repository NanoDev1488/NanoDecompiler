// исходный (обфусцированный) внутренний класс: jnr.posix.LinuxFileStatAARCH64
package jnr.posix;
...
import jnr.posix.LinuxFileStatAARCH64_Layout;
...
public final class LinuxFileStatAARCH64 extends BaseFileStat implements NanosecondFileStat {
    ...
    // ---- поля ----
  private static final LinuxFileStatAARCH64_Layout layout;

    static {
        layout = new LinuxFileStatAARCH64_Layout(Runtime.getSystemRuntime());
    }

  public LinuxFileStatAARCH64(LinuxPOSIX arg0) { // было: <init>
        super(arg0, layout);
    }
