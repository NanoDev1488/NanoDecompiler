// исходный (обфусцированный) внутренний класс: jnr.posix.LinuxFileStatSPARCV9
package jnr.posix;
...
import jnr.posix.LinuxFileStatSPARCV9_Layout;
...
public class LinuxFileStatSPARCV9 extends BaseFileStat implements NanosecondFileStat {
    ...
    // ---- поля ----
  public static final LinuxFileStatSPARCV9_Layout layout;

    static {
        layout = new LinuxFileStatSPARCV9_Layout(Runtime.getSystemRuntime());
    }

  public LinuxFileStatSPARCV9(LinuxPOSIX arg0) { // было: <init>
        super(arg0, layout);
    }
