// исходный (обфусцированный) внутренний класс: jnr.posix.FreeBSDPasswd
package jnr.posix;
...
import jnr.posix.FreeBSDPasswd_Layout;
...
public class FreeBSDPasswd extends NativePasswd implements Passwd {
    ...
    // ---- поля ----
  private static final FreeBSDPasswd_Layout layout;

    static {
        layout = new FreeBSDPasswd_Layout(Runtime.getSystemRuntime(), null);
    }

   FreeBSDPasswd(Pointer arg0) { // было: <init>
        super(arg0);
    }
