// исходный (обфусцированный) внутренний класс: jnr.posix.MacOSFileStat64Inode
package jnr.posix;
...
import jnr.posix.MacOSFileStat64Inode_Layout64Inode;
...
public final class MacOSFileStat64Inode extends BaseFileStat implements NanosecondFileStat {
    ...
    // ---- поля ----
  private static final MacOSFileStat64Inode_Layout64Inode layout;

    static {
        layout = new MacOSFileStat64Inode_Layout64Inode(Runtime.getSystemRuntime());
    }

  public MacOSFileStat64Inode(MacOSPOSIX arg0) { // было: <init>
        super(arg0, layout);
    }
