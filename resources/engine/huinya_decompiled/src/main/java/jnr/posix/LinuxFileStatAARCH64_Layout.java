// исходный (обфусцированный) внутренний класс: jnr.posix.LinuxFileStatAARCH64.Layout
package jnr.posix;
...
public final class LinuxFileStatAARCH64_Layout extends StructLayout {
  ...
  public LinuxFileStatAARCH64_Layout(Runtime arg0) { // было: <init>
        super(arg0);
