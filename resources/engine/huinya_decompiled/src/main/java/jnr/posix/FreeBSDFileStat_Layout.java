// исходный (обфусцированный) внутренний класс: jnr.posix.FreeBSDFileStat.Layout
package jnr.posix;
...
import jnr.posix.FreeBSDFileStat_Anon1;
import jnr.posix.FreeBSDFileStat_Layout_dev_t;
import jnr.posix.FreeBSDFileStat_Layout_time_t;

final class FreeBSDFileStat_Layout extends StructLayout {

    // ---- поля ----
  public final FreeBSDFileStat_Layout_dev_t st_dev;
  ...
  public final FreeBSDFileStat_Layout_dev_t st_rdev;
  public final FreeBSDFileStat_Layout_time_t st_atime;
  public final StructLayout_SignedLong st_atimensec;
  public final FreeBSDFileStat_Layout_time_t st_mtime;
  public final StructLayout_SignedLong st_mtimensec;
  public final FreeBSDFileStat_Layout_time_t st_ctime;
  ...
  public final FreeBSDFileStat_Layout_time_t st_birthtime;
  public final StructLayout_SignedLong st_birthtimensec;
  public final StructLayout_Signed64 st_qspare0;

  private FreeBSDFileStat_Layout(Runtime arg0) { // было: <init>
        super(arg0);
        st_dev = new FreeBSDFileStat_Layout_dev_t(this);
        ...
        st_rdev = new FreeBSDFileStat_Layout_dev_t(this);
        st_atime = new FreeBSDFileStat_Layout_time_t(this);
        st_atimensec = new StructLayout_SignedLong(this);
        st_mtime = new FreeBSDFileStat_Layout_time_t(this);
        st_mtimensec = new StructLayout_SignedLong(this);
        st_ctime = new FreeBSDFileStat_Layout_time_t(this);
        ...
        st_birthtime = new FreeBSDFileStat_Layout_time_t(this);
        st_birthtimensec = new StructLayout_SignedLong(this);
        st_qspare0 = new StructLayout_Signed64(this);
    }

   FreeBSDFileStat_Layout(Runtime arg0, FreeBSDFileStat_Anon1 arg1) { // было: <init>
        this(arg0);
    }
