// исходный (обфусцированный) внутренний класс: jnr.posix.LinuxFileStat64
package jnr.posix;
...
import jnr.posix.LinuxFileStat64_Layout;
...
public final class LinuxFileStat64 extends BaseFileStat implements NanosecondFileStat {
    ...
    // ---- поля ----
  private static final LinuxFileStat64_Layout layout;

    static {
        layout = new LinuxFileStat64_Layout(Runtime.getSystemRuntime());
    }

  public LinuxFileStat64(LinuxPOSIX arg0) { // было: <init>
        super(arg0, layout);
    }
