// исходный (обфусцированный) внутренний класс: jnr.posix.MacOSCmsgHdr
package jnr.posix;
...
class MacOSCmsgHdr extends BaseCmsgHdr {
    ...
    // ---- поля ----
  public static final MacOSCmsgHdr_Layout layout;

    static {
        layout = new MacOSCmsgHdr_Layout(Runtime.getSystemRuntime());
    }

  public MacOSCmsgHdr(NativePOSIX arg0, Pointer arg1) { // было: <init>
        super(arg0, arg1);
    }

  public MacOSCmsgHdr(NativePOSIX arg0, Pointer arg1, int arg2) { // было: <init>
