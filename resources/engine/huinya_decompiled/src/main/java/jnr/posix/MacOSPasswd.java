// исходный (обфусцированный) внутренний класс: jnr.posix.MacOSPasswd
package jnr.posix;
...
import jnr.posix.MacOSPasswd_Layout;
...
public final class MacOSPasswd extends NativePasswd implements Passwd {
    ...
    // ---- поля ----
  private static final MacOSPasswd_Layout layout;

    static {
        layout = new MacOSPasswd_Layout(Runtime.getSystemRuntime(), null);
    }

   MacOSPasswd(Pointer arg0) { // было: <init>
        super(arg0);
    }
