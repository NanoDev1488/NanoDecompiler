// исходный (обфусцированный) внутренний класс: jnr.posix.FreeBSDMsgHdr
package jnr.posix;
...
import jnr.posix.FreeBSDMsgHdr_Layout;
import jnr.posix.NativePOSIX;

class FreeBSDMsgHdr extends BaseMsgHdr {

    // ---- поля ----
  private static final FreeBSDMsgHdr_Layout layout;

    static {
        layout = new FreeBSDMsgHdr_Layout(Runtime.getSystemRuntime());
    }

  protected FreeBSDMsgHdr(NativePOSIX arg0) { // было: <init>
        super(arg0, layout);
        setName(null);
    }
   ...
   CmsgHdr allocateCmsgHdrInternal(NativePOSIX arg0, Pointer arg1, int arg2) {
        if (arg2 <= 0) {
            return new FreeBSDCmsgHdr(arg0, arg1);
        } else {
            return new FreeBSDCmsgHdr(arg0, arg1, arg2);
        }
    }
  ...
  public String toString() {
        ...
        while (var5 < var4.length) {
            var1.append((((FreeBSDCmsgHdr) var4[var5])).toString("    "));
