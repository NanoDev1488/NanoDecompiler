// исходный (обфусцированный) внутренний класс: jnr.posix.DefaultNativeTimeval
package jnr.posix;
...
public final class DefaultNativeTimeval extends Timeval {
  ...
  static final boolean $assertionsDisabled;
    ...
    static {
        boolean __stk1;
        __stk1 = !DefaultNativeTimeval.class.desiredAssertionStatus();
        $assertionsDisabled = __stk1;
    }

  public DefaultNativeTimeval(Runtime arg0) { // было: <init>
        super(arg0);
