// исходный (обфусцированный) внутренний класс: jnr.posix.MacOSMsgHdr.Layout
package jnr.posix;
...
public class MacOSMsgHdr_Layout extends StructLayout {
  ...
  protected MacOSMsgHdr_Layout(Runtime arg0) { // было: <init>
        super(arg0);
