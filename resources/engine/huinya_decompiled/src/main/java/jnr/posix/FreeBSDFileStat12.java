// исходный (обфусцированный) внутренний класс: jnr.posix.FreeBSDFileStat12
package jnr.posix;
...
import jnr.posix.FreeBSDFileStat12_Layout;
...
public final class FreeBSDFileStat12 extends BaseFileStat implements NanosecondFileStat {
    ...
    // ---- поля ----
  private static final FreeBSDFileStat12_Layout layout;

    static {
        layout = new FreeBSDFileStat12_Layout(Runtime.getSystemRuntime(), null);
    }

  public FreeBSDFileStat12(NativePOSIX arg0) { // было: <init>
        super(arg0, layout);
    }
