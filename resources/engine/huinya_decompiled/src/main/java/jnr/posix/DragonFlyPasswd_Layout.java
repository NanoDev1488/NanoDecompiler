// исходный (обфусцированный) внутренний класс: jnr.posix.DragonFlyPasswd.Layout
package jnr.posix;
...
import jnr.posix.DragonFlyPasswd_Anon1;

final class DragonFlyPasswd_Layout extends StructLayout {
  ...
  public final StructLayout_Signed32 pw_fields;

  private DragonFlyPasswd_Layout(Runtime arg0) { // было: <init>
        super(arg0);
        ...
        pw_fields = new StructLayout_Signed32(this);
    }

   DragonFlyPasswd_Layout(Runtime arg0, DragonFlyPasswd_Anon1 arg1) { // было: <init>
        this(arg0);
    }
