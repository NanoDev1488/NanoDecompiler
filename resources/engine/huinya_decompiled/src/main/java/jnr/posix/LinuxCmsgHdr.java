// исходный (обфусцированный) внутренний класс: jnr.posix.LinuxCmsgHdr
package jnr.posix;
...
class LinuxCmsgHdr extends BaseCmsgHdr {
    ...
    // ---- поля ----
  public static final LinuxCmsgHdr_Layout layout;

    static {
        layout = new LinuxCmsgHdr_Layout(Runtime.getSystemRuntime());
    }

  public LinuxCmsgHdr(NativePOSIX arg0, Pointer arg1) { // было: <init>
        super(arg0, arg1);
    }

  public LinuxCmsgHdr(NativePOSIX arg0, Pointer arg1, int arg2) { // было: <init>
