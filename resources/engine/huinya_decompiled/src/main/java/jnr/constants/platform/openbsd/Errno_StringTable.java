// исходный (обфусцированный) внутренний класс: jnr.constants.platform.openbsd.Errno.StringTable
package jnr.constants.platform.openbsd;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.openbsd.Errno;
...
final class Errno_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(Errno.ENOTSUP, "Not supported");
        ...
        var0.put(Errno.EPROGUNAVAIL, "RPC program not available");
        var0.put(Errno.ERPCMISMATCH, "RPC version wrong");
        var0.put(Errno.EIPSEC, "IPsec processing failure");
        return var0;
    }
