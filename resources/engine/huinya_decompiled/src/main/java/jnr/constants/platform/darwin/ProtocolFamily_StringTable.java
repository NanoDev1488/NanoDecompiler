// исходный (обфусцированный) внутренний класс: jnr.constants.platform.darwin.ProtocolFamily.StringTable
package jnr.constants.platform.darwin;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.darwin.ProtocolFamily;
...
final class ProtocolFamily_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(ProtocolFamily.PF_NDRV, "PF_NDRV");
        ...
        var0.put(ProtocolFamily.PF_SYSTEM, "PF_SYSTEM");
        var0.put(ProtocolFamily.PF_NETBIOS, "PF_NETBIOS");
        var0.put(ProtocolFamily.PF_PPP, "PF_PPP");
