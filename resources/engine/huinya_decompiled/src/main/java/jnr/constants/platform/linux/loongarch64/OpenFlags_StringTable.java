// исходный (обфусцированный) внутренний класс: jnr.constants.platform.linux.loongarch64.OpenFlags.StringTable
package jnr.constants.platform.linux.loongarch64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.linux.loongarch64.OpenFlags;
...
final class OpenFlags_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(OpenFlags.O_TMPFILE, "O_TMPFILE");
