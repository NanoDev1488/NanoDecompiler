// исходный (обфусцированный) внутренний класс: jnr.constants.platform.darwin.OpenFlags.StringTable
...
final class OpenFlags_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(OpenFlags.O_EVTONLY, "O_EVTONLY");
        var0.put(OpenFlags.O_DIRECTORY, "O_DIRECTORY");
        var0.put(OpenFlags.O_SYMLINK, "O_SYMLINK");
