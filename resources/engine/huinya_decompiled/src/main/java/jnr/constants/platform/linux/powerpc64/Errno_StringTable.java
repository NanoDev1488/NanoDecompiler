// исходный (обфусцированный) внутренний класс: jnr.constants.platform.linux.powerpc64.Errno.StringTable
package jnr.constants.platform.linux.powerpc64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.linux.powerpc64.Errno;
...
final class Errno_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(Errno.EDEADLOCK, "File locking deadlock error");
