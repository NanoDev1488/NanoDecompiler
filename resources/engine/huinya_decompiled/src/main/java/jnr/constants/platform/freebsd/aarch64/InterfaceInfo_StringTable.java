// исходный (обфусцированный) внутренний класс: jnr.constants.platform.freebsd.aarch64.InterfaceInfo.StringTable
package jnr.constants.platform.freebsd.aarch64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.freebsd.aarch64.InterfaceInfo;
...
final class InterfaceInfo_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(InterfaceInfo.IFF_CANTCONFIG, "IFF_CANTCONFIG");
        var0.put(InterfaceInfo.IFF_DEBUG, "IFF_DEBUG");
        var0.put(InterfaceInfo.IFF_DRV_OACTIVE, "IFF_DRV_OACTIVE");
        var0.put(InterfaceInfo.IFF_DRV_RUNNING, "IFF_DRV_RUNNING");
        var0.put(InterfaceInfo.IFF_DYING, "IFF_DYING");
        ...
        var0.put(InterfaceInfo.IFF_RENAMING, "IFF_RENAMING");
