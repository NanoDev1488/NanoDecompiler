// исходный (обфусцированный) внутренний класс: jnr.constants.platform.linux.loongarch64.Signal.StringTable
package jnr.constants.platform.linux.loongarch64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.linux.loongarch64.Signal;
...
final class Signal_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(Signal.SIGSTKFLT, "SIGSTKFLT");
        var0.put(Signal.SIGCLD, "SIGCLD");
        ...
        var0.put(Signal.SIGPOLL, "SIGPOLL");
        var0.put(Signal.SIGIO, "SIGIO");
        var0.put(Signal.SIGPWR, "SIGPWR");
        var0.put(Signal.SIGSYS, "SIGSYS");
        var0.put(Signal.SIGRTMIN, "SIGRTMIN");
        var0.put(Signal.SIGRTMAX, "SIGRTMAX");
