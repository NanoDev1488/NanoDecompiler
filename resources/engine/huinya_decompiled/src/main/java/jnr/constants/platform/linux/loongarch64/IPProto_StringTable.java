// исходный (обфусцированный) внутренний класс: jnr.constants.platform.linux.loongarch64.IPProto.StringTable
package jnr.constants.platform.linux.loongarch64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.linux.loongarch64.IPProto;
...
final class IPProto_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(IPProto.IPPROTO_IPIP, "IPPROTO_IPIP");
        ...
        var0.put(IPProto.IPPROTO_TP, "IPPROTO_TP");
        ...
        var0.put(IPProto.IPPROTO_GRE, "IPPROTO_GRE");
