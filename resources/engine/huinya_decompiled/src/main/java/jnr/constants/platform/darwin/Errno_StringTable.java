// исходный (обфусцированный) внутренний класс: jnr.constants.platform.darwin.Errno.StringTable
package jnr.constants.platform.darwin;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.darwin.Errno;
...
final class Errno_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(Errno.EBUSY, "Resource busy");
        ...
        var0.put(Errno.EMULTIHOP, "EMULTIHOP (Reserved)");
        var0.put(Errno.ENODATA, "No message available on STREAM");
        var0.put(Errno.ENOLINK, "ENOLINK (Reserved)");
        var0.put(Errno.ENOSR, "No STREAM resources");
        var0.put(Errno.ENOSTR, "Not a STREAM");
        var0.put(Errno.EPROTO, "Protocol error");
        var0.put(Errno.ETIME, "STREAM ioctl timeout");
