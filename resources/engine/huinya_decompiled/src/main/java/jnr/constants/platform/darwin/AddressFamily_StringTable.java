// исходный (обфусцированный) внутренний класс: jnr.constants.platform.darwin.AddressFamily.StringTable
package jnr.constants.platform.darwin;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.darwin.AddressFamily;
...
final class AddressFamily_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(AddressFamily.AF_NDRV, "AF_NDRV");
        ...
        var0.put(AddressFamily.AF_SYSTEM, "AF_SYSTEM");
        var0.put(AddressFamily.AF_NETBIOS, "AF_NETBIOS");
        var0.put(AddressFamily.AF_PPP, "AF_PPP");
