// исходный (обфусцированный) внутренний класс: jnr.constants.platform.solaris.IP.StringTable
package jnr.constants.platform.solaris;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.solaris.IP;
...
final class IP_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(IP.IP_RECVSLLA, "IP_RECVSLLA");
