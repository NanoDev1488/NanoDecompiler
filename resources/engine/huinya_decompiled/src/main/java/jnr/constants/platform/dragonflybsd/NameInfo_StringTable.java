// исходный (обфусцированный) внутренний класс: jnr.constants.platform.dragonflybsd.NameInfo.StringTable
package jnr.constants.platform.dragonflybsd;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.dragonflybsd.NameInfo;
...
final class NameInfo_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(NameInfo.NI_WITHSCOPEID, "NI_WITHSCOPEID");
        return var0;
    }
