// исходный (обфусцированный) внутренний класс: jnr.constants.platform.darwin.SocketOption.StringTable
package jnr.constants.platform.darwin;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.darwin.SocketOption;
...
final class SocketOption_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(SocketOption.SO_DONTTRUNC, "SO_DONTTRUNC");
        var0.put(SocketOption.SO_WANTMORE, "SO_WANTMORE");
        var0.put(SocketOption.SO_WANTOOBFLAG, "SO_WANTOOBFLAG");
        ...
        var0.put(SocketOption.SO_NREAD, "SO_NREAD");
        var0.put(SocketOption.SO_NKE, "SO_NKE");
        var0.put(SocketOption.SO_NOSIGPIPE, "SO_NOSIGPIPE");
        var0.put(SocketOption.SO_NOADDRERR, "SO_NOADDRERR");
        var0.put(SocketOption.SO_NWRITE, "SO_NWRITE");
        var0.put(SocketOption.SO_REUSESHAREUID, "SO_REUSESHAREUID");
