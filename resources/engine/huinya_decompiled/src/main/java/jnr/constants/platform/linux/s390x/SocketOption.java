// исходный (обфусцированный) внутренний класс: jnr.constants.platform.linux.s390x.SocketOption
package jnr.constants.platform.linux.s390x;

import java.util.Map;
import jnr.constants.Constant;
import jnr.constants.platform.linux.s390x.SocketOption_StringTable;
