// исходный (обфусцированный) внутренний класс: jnr.constants.platform.freebsd.aarch64.ProtocolFamily.StringTable
package jnr.constants.platform.freebsd.aarch64;

import java.util.EnumMap;
import java.util.Map;
import jnr.constants.platform.freebsd.aarch64.ProtocolFamily;
...
final class ProtocolFamily_StringTable {
  ...
  public static final Map generateTable() {
        ...
        var0.put(ProtocolFamily.PF_NETGRAPH, "PF_NETGRAPH");
