// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.ppc64.ibmi.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.dev_t, NativeType.UINT);
        var0.put(TypeAlias.blkcnt_t, NativeType.SINT);
        ...
        var0.put(TypeAlias.nlink_t, NativeType.SSHORT);
