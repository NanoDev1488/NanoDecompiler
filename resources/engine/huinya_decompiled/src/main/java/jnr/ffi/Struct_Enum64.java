// исходный (обфусцированный) внутренний класс: jnr.ffi.Struct.Enum64
package jnr.ffi;
...
public class Struct_Enum64 extends Struct_EnumField {

    // ---- поля ----
  final Struct this$0;

  public Struct_Enum64(Struct arg0, Class arg1) { // было: <init>
  ...
  public final void set(Enum arg0) {
        getMemory().putLongLong(offset(), ((long) EnumMapper.getInstance(enumClass).intValue(arg0)));
    }
