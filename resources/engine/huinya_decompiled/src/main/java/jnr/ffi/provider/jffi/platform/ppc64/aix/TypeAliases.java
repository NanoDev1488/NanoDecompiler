// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.ppc64.aix.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.int32_t, NativeType.SINT);
        var0.put(TypeAlias.u_int32_t, NativeType.UINT);
        var0.put(TypeAlias.int64_t, NativeType.ADDRESS);
        var0.put(TypeAlias.u_int64_t, NativeType.ADDRESS);
        ...
        var0.put(TypeAlias.blkcnt_t, NativeType.SLONG);
        var0.put(TypeAlias.blksize_t, NativeType.SINT);
        var0.put(TypeAlias.gid_t, NativeType.UINT);
        var0.put(TypeAlias.in_addr_t, NativeType.UINT);
        var0.put(TypeAlias.in_port_t, NativeType.USHORT);
        var0.put(TypeAlias.ino_t, NativeType.UINT);
        var0.put(TypeAlias.ino64_t, NativeType.ULONG);
        var0.put(TypeAlias.key_t, NativeType.SINT);
        var0.put(TypeAlias.mode_t, NativeType.UINT);
        var0.put(TypeAlias.nlink_t, NativeType.SINT);
        var0.put(TypeAlias.id_t, NativeType.UINT);
        var0.put(TypeAlias.pid_t, NativeType.SINT);
        var0.put(TypeAlias.off_t, NativeType.SLONG);
        var0.put(TypeAlias.swblk_t, NativeType.SINT);
        var0.put(TypeAlias.uid_t, NativeType.UINT);
        var0.put(TypeAlias.clock_t, NativeType.SINT);
        var0.put(TypeAlias.size_t, NativeType.ULONG);
        var0.put(TypeAlias.ssize_t, NativeType.SLONG);
        var0.put(TypeAlias.time_t, NativeType.SINT);
        var0.put(TypeAlias.fsblkcnt_t, NativeType.ULONG);
        var0.put(TypeAlias.fsfilcnt_t, NativeType.ULONG);
        var0.put(TypeAlias.sa_family_t, NativeType.UCHAR);
        var0.put(TypeAlias.socklen_t, NativeType.ULONG);
