// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.DefaultInvokerFactory.DoubleConverter
...
final class DefaultInvokerFactory_DoubleConverter extends DefaultInvokerFactory_NumberDataConverter {

    // ---- поля ----
  static final DefaultInvokerFactory_NumberDataConverter INSTANCE;

    static {
        INSTANCE = new DefaultInvokerFactory_DoubleConverter();
    }

   DefaultInvokerFactory_DoubleConverter() { // было: <init>
        super();
    }
