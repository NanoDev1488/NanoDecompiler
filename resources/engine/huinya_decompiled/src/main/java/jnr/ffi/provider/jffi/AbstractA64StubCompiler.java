// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.AbstractA64StubCompiler
...
import jnr.ffi.provider.jffi.AbstractA64StubCompiler_PageHolder;
...
abstract class AbstractA64StubCompiler extends StubCompiler {
  ...
  final List stubs_A64;
  static final AtomicIntegerFieldUpdater PAGE_HOLDER_UPDATER;

    static {
        DEBUG = Boolean.getBoolean("jnr.ffi.compile.dump");
        PAGE_HOLDER_UPDATER = AtomicIntegerFieldUpdater.newUpdater(AbstractA64StubCompiler_PageHolder.class, "disposed");
    }

  protected AbstractA64StubCompiler(Runtime arg0) { // было: <init>
        super();
        stubs_A64 = new LinkedList();
        runtime = arg0;
    }
  ...
  public final Runtime getRuntime() {
   ...
   void attach(Class arg0) {
        ...
        //      0: aload_0
        //      1: getfield  #52 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.stubs_A64:Ljava/util/List;
        ...
        //     14: lstore_2
        //     15: aload_0
        //     16: getfield  #52 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.stubs_A64:Ljava/util/List;
        ...
        //     43: checkcast  #35 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub
        //     46: astore  5
        //     48: lload_2
        //     49: aload  5
        //     51: getfield  #54 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.assembler:Ljnr/a64asm/Assembler_A64;
        //     54: invokevirtual  #91 // jnr.a64asm.Assembler_A64.codeSize:()I
        //     57: bipush  8
        //     59: iadd
        //     60: i2l
        //     61: ladd
        ...
        //    132: athrow
        //    133: new  #33 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$PageHolder
        //    136: dup
        //    137: aload  4
        //    139: lload  7
        //    141: lload  5
        //    143: invokespecial  #97 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$PageHolder.<init>:(Lcom/kenai/jffi/PageManager;JJ)V
        //    146: astore  9
        //    148: new  #23 // java.util.ArrayList
        //    151: dup
        //    152: aload_0
        //    153: getfield  #52 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.stubs_A64:Ljava/util/List;
        ...
        //    187: aload_0
        //    188: getfield  #52 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.stubs_A64:Ljava/util/List;
        ...
        //    215: checkcast  #35 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub
        //    218: astore  15
        //    220: aload  15
        //    222: getfield  #54 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.assembler:Ljnr/a64asm/Assembler_A64;
        //    225: astore  16
        //    227: lload  11
        //    229: ldc2_w  #43 // 8L
        //    232: invokestatic  #96 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.align:(JJ)J
        //    235: lstore  11
        //    237: aload  16
        //    239: invokevirtual  #91 // jnr.a64asm.Assembler_A64.codeSize:()I
        ...
        //    251: astore  17
        //    253: aload  15
        //    255: getfield  #54 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.assembler:Ljnr/a64asm/Assembler_A64;
        //    258: aload  17
        //    260: lload  11
        //    262: invokevirtual  #93 // jnr.a64asm.Assembler_A64.relocCode:(Ljava/nio/ByteBuffer;J)V
        //    265: aload  17
        ...
        //    294: getstatic  #49 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.DEBUG:Z
        //    297: ifeq  495 (offset +198)
        //    300: invokestatic  #103 // jnr.ffi.provider.jffi.X86Disassembler.isAvailable:()Z
        ...
        //    327: aload  15
        //    329: getfield  #55 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.name:Ljava/lang/String;
        ...
        //    340: aload  15
        //    342: getfield  #56 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.signature:Ljava/lang/String;
        ...
        //    354: invokestatic  #100 // jnr.ffi.provider.jffi.X86Disassembler.create:()Ljnr/ffi/provider/jffi/X86Disassembler;
        //    357: astore  18
        //    359: aload  18
        //    361: invokestatic  #95 // jnr.ffi.Platform.getNativePlatform:()Ljnr/ffi/Platform;
        //    364: invokevirtual  #94 // jnr.ffi.Platform.getCPU:()Ljnr/ffi/Platform$CPU;
        ...
        //    382: invokevirtual  #106 // jnr.ffi.provider.jffi.X86Disassembler.setMode:(Ljnr/ffi/provider/jffi/X86Disassembler$Mode;)V
        //    385: aload  18
        //    387: getstatic  #59 // jnr.ffi.provider.jffi.X86Disassembler$Syntax.INTEL:Ljnr/ffi/provider/jffi/X86Disassembler$Syntax;
        //    390: invokevirtual  #107 // jnr.ffi.provider.jffi.X86Disassembler.setSyntax:(Ljnr/ffi/provider/jffi/X86Disassembler$Syntax;)V
        //    393: aload  18
        //    395: aload_0
        //    396: getfield  #51 // jnr.ffi.provider.jffi.AbstractA64StubCompiler.runtime:Ljnr/ffi/Runtime;
        //    399: lload  11
        //    401: invokestatic  #98 // jnr.ffi.provider.jffi.MemoryUtil.newPointer:(Ljnr/ffi/Runtime;J)Ljnr/ffi/Pointer;
        //    404: aload  16
        //    406: invokevirtual  #92 // jnr.a64asm.Assembler_A64.offset:()I
        //    409: invokevirtual  #105 // jnr.ffi.provider.jffi.X86Disassembler.setInputBuffer:(Ljnr/ffi/Pointer;I)V
        //    412: aload  18
        //    414: invokevirtual  #101 // jnr.ffi.provider.jffi.X86Disassembler.disassemble:()Z
        ...
        //    429: iconst_0
        //    430: aload  18
        //    432: invokevirtual  #104 // jnr.ffi.provider.jffi.X86Disassembler.offset:()J
        //    435: invokestatic  #75 // java.lang.Long.valueOf:(J)Ljava/lang/Long;
        //    438: aastore
        //    439: dup
        //    440: iconst_1
        //    441: aload  18
        //    443: invokevirtual  #102 // jnr.ffi.provider.jffi.X86Disassembler.insn:()Ljava/lang/String;
        //    446: aastore
        ...
        //    459: aload  16
        //    461: invokevirtual  #92 // jnr.a64asm.Assembler_A64.offset:()I
        ...
        //    476: iconst_0
        //    477: aload  16
        //    479: invokevirtual  #92 // jnr.a64asm.Assembler_A64.offset:()I
        ...
        //    501: lload  11
        //    503: aload  15
        //    505: getfield  #55 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.name:Ljava/lang/String;
        //    508: aload  15
        //    510: getfield  #56 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$Stub.signature:Ljava/lang/String;
        ...
        //    522: lload  11
        //    524: aload  16
        //    526: invokevirtual  #91 // jnr.a64asm.Assembler_A64.codeSize:()I
        //    529: i2l
        //    530: ladd
        //    531: lstore  11
        ...
        //    553: getstatic  #53 // jnr.ffi.provider.jffi.AbstractA64StubCompiler$StaticDataHolder.PAGES:Ljava/util/Map;
        //    556: aload_1
        //    557: aload  9
