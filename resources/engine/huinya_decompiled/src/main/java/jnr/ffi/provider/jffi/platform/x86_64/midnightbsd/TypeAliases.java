// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.x86_64.midnightbsd.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.dev_t, NativeType.SINT);
        ...
        var0.put(TypeAlias.key_t, NativeType.SLONG);
        var0.put(TypeAlias.mode_t, NativeType.UINT);
        var0.put(TypeAlias.nlink_t, NativeType.UINT);
        ...
        var0.put(TypeAlias.socklen_t, NativeType.UINT);
        var0.put(TypeAlias.rlim_t, NativeType.ULONGLONG);
        return var0;
    }
