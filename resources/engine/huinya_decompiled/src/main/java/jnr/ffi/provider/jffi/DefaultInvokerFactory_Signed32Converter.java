// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.DefaultInvokerFactory.Signed32Converter
...
final class DefaultInvokerFactory_Signed32Converter extends DefaultInvokerFactory_NumberDataConverter {

    // ---- поля ----
  static final DefaultInvokerFactory_NumberDataConverter INSTANCE;

    static {
        INSTANCE = new DefaultInvokerFactory_Signed32Converter();
    }

   DefaultInvokerFactory_Signed32Converter() { // было: <init>
        super();
    }
