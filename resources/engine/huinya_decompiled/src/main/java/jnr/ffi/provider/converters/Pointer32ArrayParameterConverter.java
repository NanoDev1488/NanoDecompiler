// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.converters.Pointer32ArrayParameterConverter
...
import jnr.ffi.provider.converters.Pointer32ArrayParameterConverter_Out;
...
public class Pointer32ArrayParameterConverter implements ToNativeConverter {
  ...
  public static ToNativeConverter getInstance(ToNativeContext arg0) {
        ...
        return ParameterFlags.isOut(var1) ? new Pointer32ArrayParameterConverter_Out(arg0.getRuntime(), var1) : new Pointer32ArrayParameterConverter(arg0.getRuntime(), var1);
    }

   Pointer32ArrayParameterConverter(Runtime arg0, int arg1) { // было: <init>
        super();
        runtime = arg0;
        parameterFlags = arg1;
    }
  ...
  public int[] toNative(Pointer[] arg0, ToNativeContext arg1) {
        ...
        //     10: astore_3
        //     11: aload_0
        //     12: getfield  #15 // jnr.ffi.provider.converters.Pointer32ArrayParameterConverter.parameterFlags:I
        //     15: invokestatic  #25 // jnr.ffi.provider.ParameterFlags.isIn:(I)Z
        //     18: ifeq  105 (offset +87)
        //     21: iconst_0
        //     22: istore  4
        //     24: iload  4
        //     26: aload_1
        //     27: arraylength
        //     28: if_icmpge  105 (offset +77)
        //     31: aload_1
        //     32: iload  4
        //     34: aaload
