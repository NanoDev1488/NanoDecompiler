// исходный (обфусцированный) внутренний класс: jnr.ffi.StructLayout.Enum32
package jnr.ffi;
...
public class StructLayout_Enum32 extends StructLayout_EnumField {

    // ---- поля ----
  final StructLayout this$0;

  public StructLayout_Enum32(StructLayout arg0, Class arg1) { // было: <init>
        super(arg0, NativeType.SINT, arg1);
        this$0 = arg0;
    }

  public StructLayout_Enum32(StructLayout arg0, Class arg1, StructLayout_Offset arg2) { // было: <init>
        super(arg0, NativeType.SINT, arg1, arg2);
        this$0 = arg0;
    }

  public void set(Pointer arg0, Enum arg1) {
        arg0.putInt(offset(), enumMapper.intValue(arg1));
    }

  public void set(Pointer arg0, Number arg1) {
        arg0.putInt(offset(), arg1.intValue());
    }

  public final int intValue(Pointer arg0) {
        return arg0.getInt(offset());
    }
