// исходный (обфусцированный) внутренний класс: jnr.ffi.StructLayout.Signed16
package jnr.ffi;
...
public class StructLayout_Signed16 extends StructLayout_NumberField {

    // ---- поля ----
  final StructLayout this$0;

  public StructLayout_Signed16(StructLayout arg0) { // было: <init>
        super(arg0, NativeType.SSHORT);
        this$0 = arg0;
    }

  public StructLayout_Signed16(StructLayout arg0, StructLayout_Offset arg1) { // было: <init>
