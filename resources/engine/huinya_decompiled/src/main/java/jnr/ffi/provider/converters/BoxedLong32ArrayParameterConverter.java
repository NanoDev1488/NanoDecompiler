// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.converters.BoxedLong32ArrayParameterConverter
...
import jnr.ffi.provider.converters.BoxedLong32ArrayParameterConverter_Out;
...
public class BoxedLong32ArrayParameterConverter implements ToNativeConverter {
  ...
  private final int parameterFlags;
    ...
    static {
        ...
        OUT = new BoxedLong32ArrayParameterConverter_Out(1);
        INOUT = new BoxedLong32ArrayParameterConverter_Out(3);
    }
  ...
  public BoxedLong32ArrayParameterConverter(int arg0) { // было: <init>
        super();
        parameterFlags = arg0;
    }
  ...
  public int[] toNative(Long[] arg0, ToNativeContext arg1) {
        ...
        //     10: astore_3
        //     11: aload_0
        //     12: getfield  #15 // jnr.ffi.provider.converters.BoxedLong32ArrayParameterConverter.parameterFlags:I
        ...
        //     42: iload  4
        //     44: aaload
        //     45: invokevirtual  #16 // java.lang.Long.intValue:()I
        //     48: goto  52 (offset +4)
        //     51: iconst_0
        //     52: iastore
        //     53: iinc  4, 1
