// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.aarch64.windows.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.intptr_t, NativeType.SLONGLONG);
        var0.put(TypeAlias.uintptr_t, NativeType.ULONGLONG);
        ...
        var0.put(TypeAlias.id_t, NativeType.SINT);
        var0.put(TypeAlias.pid_t, NativeType.SLONGLONG);
        var0.put(TypeAlias.off_t, NativeType.SLONGLONG);
        var0.put(TypeAlias.swblk_t, NativeType.SLONG);
        var0.put(TypeAlias.uid_t, NativeType.SINT);
        var0.put(TypeAlias.clock_t, NativeType.SINT);
        var0.put(TypeAlias.size_t, NativeType.ULONGLONG);
        var0.put(TypeAlias.ssize_t, NativeType.SLONGLONG);
        var0.put(TypeAlias.time_t, NativeType.SLONGLONG);
        ...
        var0.put(TypeAlias.rlim_t, NativeType.SINT);
