// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.riscv64.linux.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.int64_t, NativeType.SLONG);
        var0.put(TypeAlias.u_int64_t, NativeType.ULONG);
        ...
        var0.put(TypeAlias.ino_t, NativeType.ULONG);
        ...
        var0.put(TypeAlias.clock_t, NativeType.SLONG);
