// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.converters.BoxedShortArrayParameterConverter
...
import jnr.ffi.provider.converters.BoxedShortArrayParameterConverter_Out;
...
public class BoxedShortArrayParameterConverter implements ToNativeConverter {
  ...
  private final int parameterFlags;
    ...
    static {
        IN = new BoxedShortArrayParameterConverter(2);
        OUT = new BoxedShortArrayParameterConverter_Out(1);
        INOUT = new BoxedShortArrayParameterConverter_Out(3);
    }
  ...
  public BoxedShortArrayParameterConverter(int arg0) { // было: <init>
        super();
        parameterFlags = arg0;
    }

  public short[] toNative(Short[] arg0, ToNativeContext arg1) {
        ...
        //     10: astore_3
        //     11: aload_0
        //     12: getfield  #15 // jnr.ffi.provider.converters.BoxedShortArrayParameterConverter.parameterFlags:I
        ...
        //     42: iload  4
        //     44: aaload
        //     45: invokevirtual  #17 // java.lang.Short.shortValue:()S
        //     48: goto  52 (offset +4)
        //     51: iconst_0
        //     52: sastore
        //     53: iinc  4, 1
  ...
  public Object toNative(Object arg0, ToNativeContext arg1) {
        return toNative(((Short[]) arg0), arg1);
    }
