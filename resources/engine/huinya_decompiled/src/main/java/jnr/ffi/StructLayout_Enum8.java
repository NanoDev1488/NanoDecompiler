// исходный (обфусцированный) внутренний класс: jnr.ffi.StructLayout.Enum8
package jnr.ffi;
...
public class StructLayout_Enum8 extends StructLayout_EnumField {

    // ---- поля ----
  final StructLayout this$0;

  public StructLayout_Enum8(StructLayout arg0, Class arg1) { // было: <init>
        super(arg0, NativeType.SCHAR, arg1);
        this$0 = arg0;
    }

  public StructLayout_Enum8(StructLayout arg0, Class arg1, StructLayout_Offset arg2) { // было: <init>
        super(arg0, NativeType.SCHAR, arg1, arg2);
        this$0 = arg0;
    }

  public final void set(Pointer arg0, Enum arg1) {
        arg0.putByte(offset(), ((byte) enumMapper.intValue(arg1)));
    }
