// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.DefaultInvokerFactory.Signed8Converter
...
final class DefaultInvokerFactory_Signed8Converter extends DefaultInvokerFactory_NumberDataConverter {

    // ---- поля ----
  static final DefaultInvokerFactory_NumberDataConverter INSTANCE;

    static {
        INSTANCE = new DefaultInvokerFactory_Signed8Converter();
    }

   DefaultInvokerFactory_Signed8Converter() { // было: <init>
        super();
    }
