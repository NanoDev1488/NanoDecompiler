// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.converters.BoxedBooleanArrayParameterConverter
...
import jnr.ffi.provider.converters.BoxedBooleanArrayParameterConverter_Out;
...
public class BoxedBooleanArrayParameterConverter implements ToNativeConverter {
  ...
  private final int parameterFlags;
    ...
    static {
        ...
        OUT = new BoxedBooleanArrayParameterConverter_Out(1);
        INOUT = new BoxedBooleanArrayParameterConverter_Out(3);
    }
  ...
  public BoxedBooleanArrayParameterConverter(int arg0) { // было: <init>
        super();
        parameterFlags = arg0;
    }

  public boolean[] toNative(Boolean[] arg0, ToNativeContext arg1) {
        ...
        //     10: astore_3
        //     11: aload_0
        //     12: getfield  #15 // jnr.ffi.provider.converters.BoxedBooleanArrayParameterConverter.parameterFlags:I
        ...
        //     42: iload  4
        //     44: aaload
        //     45: invokevirtual  #16 // java.lang.Boolean.booleanValue:()Z
        //     48: goto  52 (offset +4)
        //     51: iconst_0
        //     52: bastore
        //     53: iinc  4, 1
