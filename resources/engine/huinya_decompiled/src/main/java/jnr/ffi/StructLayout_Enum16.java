// исходный (обфусцированный) внутренний класс: jnr.ffi.StructLayout.Enum16
package jnr.ffi;
...
public class StructLayout_Enum16 extends StructLayout_EnumField {

    // ---- поля ----
  final StructLayout this$0;

  public StructLayout_Enum16(StructLayout arg0, Class arg1) { // было: <init>
        super(arg0, NativeType.SSHORT, arg1);
        this$0 = arg0;
    }

  public StructLayout_Enum16(StructLayout arg0, Class arg1, StructLayout_Offset arg2) { // было: <init>
        super(arg0, NativeType.SSHORT, arg1, arg2);
        this$0 = arg0;
    }

  public void set(Pointer arg0, Enum arg1) {
        arg0.putShort(offset(), ((short) enumMapper.intValue(arg1)));
    }
