// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.x86_64.darwin.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.fsblkcnt_t, NativeType.UINT);
        var0.put(TypeAlias.fsfilcnt_t, NativeType.UINT);
        ...
        var0.put(TypeAlias.speed_t, NativeType.ULONG);
        var0.put(TypeAlias.tcflag_t, NativeType.ULONG);
        return var0;
    }
