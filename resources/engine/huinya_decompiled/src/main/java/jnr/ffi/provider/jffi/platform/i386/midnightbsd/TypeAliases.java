// исходный (обфусцированный) внутренний класс: jnr.ffi.provider.jffi.platform.i386.midnightbsd.TypeAliases
...
public final class TypeAliases {
  ...
  private static Map buildTypeMap() {
        ...
        var0.put(TypeAlias.intptr_t, NativeType.SINT);
        var0.put(TypeAlias.uintptr_t, NativeType.UINT);
        ...
        var0.put(TypeAlias.blksize_t, NativeType.UINT);
        ...
        var0.put(TypeAlias.id_t, NativeType.SLONGLONG);
        ...
        var0.put(TypeAlias.fsblkcnt_t, NativeType.ULONGLONG);
        var0.put(TypeAlias.fsfilcnt_t, NativeType.ULONGLONG);
        var0.put(TypeAlias.sa_family_t, NativeType.UCHAR);
        var0.put(TypeAlias.socklen_t, NativeType.UINT);
        var0.put(TypeAlias.rlim_t, NativeType.SLONGLONG);
        return var0;
    }
