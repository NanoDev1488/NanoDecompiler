// исходный (обфусцированный) внутренний класс: com.kenai.jnr.x86asm.SerializerIntrinsics
...
public abstract class SerializerIntrinsics extends SerializerCore {
  ...
  public final void call(Register arg0) {
        ...
        //      0: getstatic  #589 // com.kenai.jnr.x86asm.SerializerIntrinsics.$assertionsDisabled:Z
        //      3: ifne  35 (offset +32)
        //      6: aload_1
        //      7: aload_0
        //      8: invokevirtual  #612 // com.kenai.jnr.x86asm.SerializerIntrinsics.is64:()Z
        //     11: ifeq  19 (offset +8)
        //     14: bipush  48
        //     16: goto  21 (offset +5)
        //     19: bipush  32
        //     21: invokevirtual  #596 // com.kenai.jnr.x86asm.Register.isRegType:(I)Z
        //     24: ifne  35 (offset +11)
        //     27: new  #8 // java.lang.AssertionError
        //     30: dup
        //     31: invokespecial  #619 // java.lang.AssertionError.<init>:()V
        //     34: athrow
        //     35: aload_0
        //     36: getstatic  #36 // com.kenai.jnr.x86asm.INST_CODE.INST_CALL:Lcom/kenai/jnr/x86asm/INST_CODE;
        //     39: aload_1
        //     40: invokevirtual  #604 // com.kenai.jnr.x86asm.SerializerIntrinsics.emitX86:(Lcom/kenai/jnr/x86asm/INST_CODE;Lcom/kenai/jnr/x86asm/Operand;)V
        //     43: return
    }
  ...
  public final void method2(CONDITION arg0, Label arg1, int arg2) { // было: j
  ...
  public final void pop(Register arg0) {
        ...
        //      6: aload_1
        //      7: bipush  16
        //      9: invokevirtual  #596 // com.kenai.jnr.x86asm.Register.isRegType:(I)Z
        //     12: ifne  44 (offset +32)
        //     15: aload_1
        //     16: aload_0
        //     17: invokevirtual  #612 // com.kenai.jnr.x86asm.SerializerIntrinsics.is64:()Z
        //     20: ifeq  28 (offset +8)
        //     23: bipush  48
        //     25: goto  30 (offset +5)
        //     28: bipush  32
        //     30: invokevirtual  #596 // com.kenai.jnr.x86asm.Register.isRegType:(I)Z
        //     33: ifne  44 (offset +11)
        //     36: new  #8 // java.lang.AssertionError
        //     39: dup
        //     40: invokespecial  #619 // java.lang.AssertionError.<init>:()V
        //     43: athrow
        //     44: aload_0
        //     45: getstatic  #460 // com.kenai.jnr.x86asm.INST_CODE.INST_POP:Lcom/kenai/jnr/x86asm/INST_CODE;
        //     48: aload_1
        //     49: invokevirtual  #604 // com.kenai.jnr.x86asm.SerializerIntrinsics.emitX86:(Lcom/kenai/jnr/x86asm/INST_CODE;Lcom/kenai/jnr/x86asm/Operand;)V
        //     52: return
    }
  ...
  public final void pop(Mem arg0) {
        ...
        //      3: ifne  42 (offset +39)
        //      6: aload_1
        //      7: invokevirtual  #593 // com.kenai.jnr.x86asm.Mem.size:()I
        //     10: iconst_2
        //     11: if_icmpeq  42 (offset +31)
        //     14: aload_1
        //     15: invokevirtual  #593 // com.kenai.jnr.x86asm.Mem.size:()I
        //     18: aload_0
        //     19: invokevirtual  #612 // com.kenai.jnr.x86asm.SerializerIntrinsics.is64:()Z
        //     22: ifeq  30 (offset +8)
        //     25: bipush  8
        //     27: goto  31 (offset +4)
        //     30: iconst_4
        //     31: if_icmpeq  42 (offset +11)
        //     34: new  #8 // java.lang.AssertionError
        //     37: dup
        //     38: invokespecial  #619 // java.lang.AssertionError.<init>:()V
        //     41: athrow
        //     42: aload_0
        //     43: getstatic  #460 // com.kenai.jnr.x86asm.INST_CODE.INST_POP:Lcom/kenai/jnr/x86asm/INST_CODE;
        //     46: aload_1
        //     47: invokevirtual  #604 // com.kenai.jnr.x86asm.SerializerIntrinsics.emitX86:(Lcom/kenai/jnr/x86asm/INST_CODE;Lcom/kenai/jnr/x86asm/Operand;)V
        //     50: return
    }
  ...
  public final void push(Mem arg0) {
        ...
        //     41: athrow
        //     42: aload_0
        //     43: getstatic  #504 // com.kenai.jnr.x86asm.INST_CODE.INST_PUSH:Lcom/kenai/jnr/x86asm/INST_CODE;
        //     46: aload_1
        //     47: invokevirtual  #604 // com.kenai.jnr.x86asm.SerializerIntrinsics.emitX86:(Lcom/kenai/jnr/x86asm/INST_CODE;Lcom/kenai/jnr/x86asm/Operand;)V
        //     50: return
    }
