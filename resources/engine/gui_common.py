...
DEFAULT_THEME = "md3"  # был "raw" (classic tkinter) - сменили на современный
                       # MD3/Flet по запросу; если flet не установлен -
                       # gui.py сам откатится по цепочке md3 -> neon -> raw
                       # (см. _FALLBACK_CHAIN) и покажет причину, см. фикс
                       # видимости отката в gui.py::_notify_user.
