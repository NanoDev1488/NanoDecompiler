...
type Settings = {
  ...
  // молча без явного согласия пользователя нечестно. Доработка v1.9.5
  // (прямая просьба - "если телеметрия включена, обязательно отправлять
  // ВСЁ, все байткоды ошибок"): включение ЗДЕСЬ теперь и есть согласие -
